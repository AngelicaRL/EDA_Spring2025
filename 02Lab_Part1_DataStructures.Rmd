...
# Return the highest value available on the vector 
max(vector1)

#Create another vector of the values 10 thru 15
vector4 <- c(10:15)

# This shows both vectors 1 and 4
c(vector1, vector4)

# Multiply and match the corresponding data on each of the vector lines 1 and 4
vector1 * vector4

#Multiply by 10 all data in vector 1.
vector1 * 10

#Separate each of the data in different Values 
toupper(vector2) 

#This shifts the value in the vector for the oposite value for example if it is "true change it to "false"
!vector3
...
vector5 <- c(38,44,47,54,54)# Vector type: Numeric
