...
class(NTL.phys.data$sampledate) #To see what type of data is it 
# Format sampledate as date
NTL.phys.data$sampledate <- as.Date(NTL.phys.data$sampledate, format = "%m/%d/%y") #To Change the format of the data From "factor" to a "DATE"Head 
```
