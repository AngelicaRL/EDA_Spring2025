...
```{r project.setup, echo=T, error=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r data.summary, mean-tables, echo=FALSE, message=FALSE, warning=FALSE}
...
cat("\n Mean Particulates (2.5mm)  \n")
kable(summary_PM25, col.names = c("County", "$\\mu g/m^3$"), digits = 2, format = "markdown")

cat("\n Mean Ozone  \n")
kable(summary_Ozone, col.names = c("County", "$\\mu g/m^3$"), digits = 2, format = "markdown")
...
```{r ozone-boxplot-2018, echo=FALSE, fig.align="left", fig.height=4, fig.width=6, fig.cap="Distribution of Ozone Levels by Month (2018)",warning=FALSE}
...
ggplot(ozone_2018, aes(x = factor(month(Date)), y = Ozone)) +
  ...
  labs(title = "Ozone Levels by Month (2018)", x = "Month", y = "Ozone (ppm)") +
  theme_minimal()


```

```{r ozone-boxplot-2019, echo=FALSE, fig.align="left", fig.height=4, fig.width=6, fig.cap="Distribution of Ozone Levels by Month (2019)", warning=FALSE}
...
ggplot(ozone_2019, aes(x = factor(month(Date)), y = Ozone)) +
  ...
  labs(title = "Ozone Levels by Month (2019)", x = "Month", y = "Ozone (ppm)") +
  theme_minimal()
...
https://github.com/AngelicaRL/EDA_Spring2025/blob/main/Assignments/Class%206/AngelicaRodriguez_A06_Crafting_Reports.Rmd 

Assignments/Class 6/AngelicaRodriguez_A06_Crafting_Reports.Rmd
