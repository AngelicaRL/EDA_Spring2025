...
> Answer: Most of my experience has been arround descriptive statistics. It is my first experience with R and git so I´m not familiar at all with them. 
...
> Answer: Mostly, data mistakes or wrong data analysis can be done by using the wrong code or not using the software well, creating false analysis.
...
> Answer: https://github.com/AngelicaRL/EDA_Spring2025
